    ...
    <main className="min-h-screen bg-background text-white py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-2xl text-gray-300 mb-16 max-w-4xl">
          <p>
            Korte beschrijving van project 2.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16">
          ...
          <div>
            <img
              src="/images/project2-detail.jpg" // Voeg je eigen afbeelding toe
              alt="Project detail"
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <img
              src="/images/project2-result1.jpg" // Voeg je eigen afbeelding toe
              alt="Project resultaat 1"
              className="rounded-lg w-full h-auto"
            />
            <img
              src="/images/project2-result2.jpg" // Voeg je eigen afbeelding toe
