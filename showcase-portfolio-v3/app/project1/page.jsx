    ...
    <main className="min-h-screen bg-background text-white py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16">
          ...
          <div>
            <img
              src="/images/project1-detail.jpg" // Voeg je eigen afbeelding toe
              alt="Project detail"
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <img
              src="/images/project1-result1.jpg" // Voeg je eigen afbeelding toe
              alt="Project resultaat 1"
              className="rounded-lg w-full h-auto"
            />
            <img
              src="/images/project1-result2.jpg" // Voeg je eigen afbeelding toe
